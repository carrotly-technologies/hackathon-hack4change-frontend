...
export type GetCountriesQuery = { __typename?: 'Query', countries: Array<{ __typename?: 'Country', name: string, capital?: string | null, code: string, currency?: string | null, continent: { __typename?: 'Continent', code: string, name: string } }> };
